...
// Counter discipline: the FMA count of CSR/BSR SpMV is exactly the number
// of stored scalar entries (A.nnz), known a priori. The kernel does not
// touch a counter; the caller increments by nnz(A).
//
// References
// ----------
