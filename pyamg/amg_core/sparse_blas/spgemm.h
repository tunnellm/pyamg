...
//
// Counter discipline: kernel does not maintain an FMA counter. Exact FMA
// count for C = A @ B is computable from input patterns alone — see
// pyamg.util.utils.spmm_work.
//
// References
// ----------
